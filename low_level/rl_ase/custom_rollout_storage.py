...
class RolloutStorage:
    ...
    def __init__(
        ...
        #self.last_state_buf = torch.zeros(
        #    num_transitions_per_env, num_envs, 2*actions_shape[0], device=self.device
        #)
    ...
    def add_transitions(self, transition: Transition):
        ...
        # self.last_state_buf[self.step].copy_(transition.last_state_buf)
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        # Added by Philippe
        # last_state_buf = self.last_state_buf.flatten(0,1)
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                # last_state_buf_batch = last_state_buf[batch_idx]
                ...
                yield obs_batch, privileged_observations_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, old_mu_batch, old_sigma_batch, (
                    None,
                    None,
                ), None, rnd_state_batch, # last_state_buf_batch # Last one by Philippe
